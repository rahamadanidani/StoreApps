...
// kelas ini di gunakan untuk menampilkan semua fitur yang ditampilkan mulai dari mendownload aplikasi
//cara kerja aplikasinya dan repository.
@HiltAndroidApp
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            val channel = NotificationChannel(
                ...
                importance
            ).apply { // ini untuk notifikasi tampilan
